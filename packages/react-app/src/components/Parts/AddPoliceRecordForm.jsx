...
const incidents = ["hit road divider", "hit road sign", "hit another car", "fall off bridge", "hit animal crossing the road"]

export default function AddPoliceRecordForm({
    visible,
    setVisible,
    vehicleDetails,
    writeContracts,
    ...
    const handleOk = async () => {
        ...
        const data = await pinJsonToIpfs(obj, name, "d91c1c142f067b652a0c", "868e2bdeebb78dd531969872283050ceeda15a72f78cef991150dac03daac740");
    ...
    return (
        <Modal
            ...
            footer={[
                <Button key="fillForm" type="link" htmlType="button" onClick={onFill}>Fill form</Button>,
                <Button key="cancel" onClick={handleCancel}>Cancel</Button>,
                <Button key="submit" type="primary" loading={confirmLoading} onClick={handleOk}>Confirm</Button>
            ]}>
            <Form
                form={form}
                labelCol={{ span: 4 }}
